"""smorgasboard_16770 URL Configuration
...
admin.site.site_header = "Smorgasboard"
admin.site.site_title = "Smorgasboard Admin Portal"
admin.site.index_title = "Smorgasboard Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Smorgasboard API",
        default_version="v1",
        description="API documentation for Smorgasboard App",
    ),
    public=True,
